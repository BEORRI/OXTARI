    ...
    <div className="flex justify-between items-center mb-10">
      ...
      <div className="flex flex-row items-center gap-5">
        ...
        <div className="flex flex-col">
          <p className="text-xl font-subtitle font-bold text-gray-900">{title}</p>
          <p className="text-sm text-gray-600 font-light font-amiri">{subtitle}</p>
        </div>
      ...
      <div className="flex flex-row justify-center items-center">
        ...
        <div className="hidden md:flex flex-row items-center gap-3 justify-between">
          ...
          {/* <div
            className={`sm:h-[3vh] lg:h-[5vh] mx-1 hidden md:block bg-text-alt-oxtari w-px`}
          ></div> */}
